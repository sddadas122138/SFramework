...
class AndroidPostBuildProcessor : IPostGenerateGradleAndroidProject
{
    ...
    private string privacyEmail = "584335607@qq.com";

    public int callbackOrder { get { return 999; } }
    public void OnPostGenerateGradleAndroidProject(string path)
    {
        Debug.Log("执行AndroidPostBuildProcessor：" + path);
    ...
    private string privacyString = @"
        ...
        if (privacyFlag == true) {
            ...
            dialog.setMessage("""" +
                    ...
                    ""1.2.2 设备信息与日志信息\n"" +
                    ""a.为了保障软件服务的安全、运营的质量及效率，我们会收集您的硬件型号、在收集 Android ID、传感器、MAC 地址、软件安装列表、操作系统版本号、国际移动设备识别码、唯一设备标识符、网络设备硬件地址、IP 地址、软件版本号、网络接入方式、状态、网络质量数据。\n"" +
                    ...
                    ""第三方 SDK 名称：Unity 3D应用场景： 框架可能收集的个人信息的类型：读取设备信息（设备型号、系统名称、系统版本、MAC 地址、IMEI、Android ID）、访问相机、应用安装列表、任务列表、网络状态信息、设备传感器列表第三方 SDK 提供方：Unity Technologies隐私政策链接：https://unity.com/cn/legal/privacy-policy \n"" +
                    ""2.我们如何使用Cookie等同类技术\n"" +
